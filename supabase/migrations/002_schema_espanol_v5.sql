-- Migration: 002_schema_espanol_v5.sql
...
-- HANDLE ORPHANS: If owner doesn't exist in perfiles (and thus not in auth), set to NULL
...
SELECT 
  ...
  p.currency, 
  NULL, 
  -- Check if owner exists in perfiles, otherwise NULL to avoid FK error
